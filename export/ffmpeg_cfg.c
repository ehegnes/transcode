...
//    {"keyint", &lavc_param_keyint, CONF_TYPE_INT, 0, 0, 0, NULL},
    ...
    {"trunc", &lavc_param_trunc, CONF_TYPE_FLAG, 0, 0, CODEC_FLAG_TRUNCATED, NULL},
    {"closedgop", &lavc_param_closedgop, CONF_TYPE_FLAG, 0, 0, CODEC_FLAG_CLOSED_GOP, NULL},
    {"intra_dc_precision", &lavc_param_intra_dc_precision, CONF_TYPE_INT, CONF_RANGE, 0, 16, NULL},
    {"skip_top", &lavc_param_skip_top, CONF_TYPE_INT, CONF_RANGE, 0, 1000, NULL},
    {"skip_bottom", &lavc_param_skip_bottom, CONF_TYPE_INT, CONF_RANGE, 0, 1000, NULL},
    {"fps_code", &lavc_param_fps_code, CONF_TYPE_INT, CONF_RANGE, 0, 9, NULL},
