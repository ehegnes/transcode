// process_vid_plugins(frame)
// process_aud_plugins(frame)
//	decoder.c
//	encoder-buffer.c
//	frame_threads.c
//	... called to run filters
// plugin_close()
// filter_close()
//      transcode.c
//      ... called when shutting down (filter_close() -> plugin_close())
// plugin_init(vob)
// filter_init()
//      transcode.c
//      ... called when starting up (plugin_init() -> filter_init())
// plugin_by_name(name, instance)
//      ... not used
// plugin_find_id(s)
//      export/export_ffmpeg.c
//      socket.c
//      ... filter name and instance number -> filter ID
// plugin_get_handle(name)
//      export/export_ffmpeg.c
//      filter/preview/filter_pv.c
//      import/import_ffmpeg.c
//      tools/tcmodinfo.c (defined)
//      tools/tcexport.c (defined)
//      ... plugin_find_id(), and load if not found
// plugin_disable_id(id)
// plugin_enable_id(id)
//      filter/preview/filter_pv.c
//      socket.c
//      ... disable or enable given ID
// plugin_single_close(id)
//      ... only called locally
// load_single_plugin(mfilter_string)
//      socket.c (and local)
//      ... load the given plugin
// filter_single_readconf(id)
//      filter/preview/filter_pv.c
//      socket.c
//      ... returns filter config string
// filter_single_configure_handle(handle, options)
//      filter/preview/filter_pv.c
//      socket.c
//      ... configures filter
...
// tc_filter_fini()
//      ... init/shutdown
// tc_filter_process(frame, type)
//      ... type is TC_AUDIO or TC_VIDEO
//      ... do TC_FRAME_IS_OUT_OF_RANGE check _before_ calling
// tc_filter_add(name, options)
//      ... returns ID
// tc_filter_find(name, or_add)
//      ... temp, should go away (force modules to always add)
// tc_filter_configure(id, options)
// tc_filter_get_conf(id)
// tc_filter_enable(id)
// tc_filter_disable(id)
// tc_filter_remove(id)
//      ... obvious
