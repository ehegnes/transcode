...
; //
; //  v1.0 2000-07-22 (initial release)
; //     
...
extern bb_fdct_one_corr		
extern bb_fdct_r_row				;  Defined in C for convenience
		;;
		;; Concatenated table of forward dct transformation coeffs.
		;; 
extern  bb_fdct_tg_all_16			; Defined in C for convenience
		;; Offsets into table..
...
%define ocos_4_16 (TABLEF + 32)		
		...
		;; 
extern bb_tab_frw_01234567		; Defined in C for convenience
...
.mmx32_fdct_col03: 
    ...
    por mm1,  [bb_fdct_one_corr] ; correction y2 +0.5
    ...
    por mm5,  [bb_fdct_one_corr] ; correction y6 +0.5
    psllw mm1, SHIFT_FRW_COL ; t4

    por mm2,  [bb_fdct_one_corr] ; correction tp65 +0.5
    movq mm4, mm1 ; 4 ; t4
    ...
    por mm0,  [bb_fdct_one_corr] ; correction y1 +0.5
...
;    }   ; end of forward_dct_col07() 
  ...
  ;  input data.
	...
	lea TABLE,  [bb_tab_frw_01234567]; ; row 0
	 mov OUT, INP;

	lea round_frw_row,  [bb_fdct_r_row];
