...
void oneDimensionalFwdDCT_fast_up (int16_t* sInput)
{
    ...
    sInput[2] = ( sBuffer2[2] * (int16_t)(m_c6*4096) + sBuffer2[3] * (int16_t)(m_c2*4096) )>>8;
    sInput[6] = ( sBuffer2[3] * (int16_t)(m_c6*4096) - sBuffer2[2] * (int16_t)(m_c2*4096) )>>8;
    ...
    sInput[1] = ( sBuffer[4] * (int16_t)(m_c7*4096) + sBuffer[7] * (int16_t)(m_c1*4096) )>>10;
    sInput[5] = ( sBuffer[5] * (int16_t)(m_c3*4096) + sBuffer[6] * (int16_t)(m_c5*4096) )>>10;
    sInput[7] = ( sBuffer[7] * (int16_t)(m_c7*4096) - sBuffer[4] * (int16_t)(m_c1*4096) )>>10;
    sInput[3] = ( sBuffer[6] * (int16_t)(m_c3*4096) - sBuffer[5] * (int16_t)(m_c5*4096) )>>10;
}
void oneDimensionalFwdDCT_fast_down (int16_t* sInput)
{
    ...
    sInput[8*0] = ( (sBuffer2[0] + sBuffer2[1]) * (int16_t)(m_c4*4096) )>>16;
    sInput[8*4] = ( (sBuffer2[0] - sBuffer2[1]) * (int16_t)(m_c4*4096) )>>16;
    sInput[8*2] = ( sBuffer2[2] * (int16_t)(m_c6*4096) + sBuffer2[3] * (int16_t)(m_c2*4096) )>>16;
    sInput[8*6] = ( sBuffer2[3] * (int16_t)(m_c6*4096) - sBuffer2[2] * (int16_t)(m_c2*4096) )>>16;
    ...
    sInput[8*1] = ( sBuffer[4] * (int16_t)(m_c7*4096) + sBuffer[7] * (int16_t)(m_c1*4096) )>>18;
    sInput[8*5] = ( sBuffer[5] * (int16_t)(m_c3*4096) + sBuffer[6] * (int16_t)(m_c5*4096) )>>18;
    sInput[8*7] = ( sBuffer[7] * (int16_t)(m_c7*4096) - sBuffer[4] * (int16_t)(m_c1*4096) )>>18;
    sInput[8*3] = ( sBuffer[6] * (int16_t)(m_c3*4096) - sBuffer[5] * (int16_t)(m_c5*4096) )>>18;
}
