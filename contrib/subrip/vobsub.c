/*
 * This file is copied from the mplayer deistribution
...
//#include "config.h"
//#include "version.h"
#define VERSION "0.90pre6-2.95.3 "
...
#define spudec_new_scaled_vobsub(a, b, c, d, e) printf("BUG:spudec_new_scaled_vobsub called\n")
